...
app.use(
 ...
 var pat1 = require("./hpsPatient"); //actual file medDoctor.js in express hospital folder
app.use("/patient", pat1); //check with /patient url in postman or web 

var doc1 = require("./hpsDoctor"); //actual file medDoctor.js in express hospital folder
app.use("/doctor", doc1); //check with /patient url in postman or web

var his1 = require("./hpsHistory"); //actual file medPatientHistory.js in express hospital folder
app.use("/history", his1); //check with /history url in postman or web

var treat1 = require("./hpsTreatment"); //actual file medPatientTreatment.js in express hospital folder
app.use("/treatment", treat1); //check with /treatment url in postman or web 

app.listen(3000, () =>
  console.log("Hospital MongoDB Medical records server has started")
);
