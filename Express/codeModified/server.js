...
var college1 = require("./college")
app.use("/department", college1)    //if url has user, it will go to college.js 



app.listen(3000, () => console.log("College server has started"));
